...
class {task_name}(Imagine_Task):
    ...
    def check_success(self):
        ...
        Prompt = (
            ...
            f"# Available API for playing once: \n{available_env_function_play_once}\n\n"
    ...
    res = generate(message, gpt="local", temperature=0)
    print(res)
    ...
    # 提取每个方法的代码
    load_actors_code = res[load_actors_start:play_once_start].strip()
    play_once_code = res[play_once_start:check_success_start].strip()
...
"""
Usage:
python code_gen/task_generation_new.py task_name
"""
