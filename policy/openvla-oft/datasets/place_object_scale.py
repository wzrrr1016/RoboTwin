...
class aloha_place_object_scale(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/place_object_scale/processed_openvla/train/*.hdf5"
        )
        val_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/place_object_scale/processed_openvla/val/*.hdf5"
        )
...
if __name__ == "__main__":
    ...
    builder = aloha_place_object_scale()
