...
class aloha_stack_bowls_three_clean_builder(MultiThreadedDatasetBuilder):
            ...
            features=tfds.features.FeaturesDict(
                {
                    ...
                    "episode_metadata": tfds.features.FeaturesDict(
                        {
                            "file_path": tfds.features.Sequence(tfds.features.Text()),
                        }
                    ),
                }
            )
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/stack_bowls_three/processed_openvla_clean/train/*.hdf5"
        )
        val_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/stack_bowls_three/processed_openvla_clean/val/*.hdf5"
        )
...
if __name__ == "__main__":
    builder = aloha_stack_bowls_three_clean_builder()
