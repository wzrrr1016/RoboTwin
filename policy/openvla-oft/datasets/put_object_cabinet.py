...
class aloha_put_object_cabinet(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/put_object_cabinet/processed_openvla/train/*.hdf5"
        )
        val_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/put_object_cabinet/processed_openvla/val/*.hdf5"
        )
...
if __name__ == "__main__":
    builder = aloha_put_object_cabinet()
