...
class aloha_stack_bowls_three(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/stack_bowls_three/processed_openvla/train/*.hdf5"
        )
        val_files = glob.glob(
            "/mnt/data/VLA_flowmatching/RoboTwin/data/stack_bowls_three/processed_openvla/val/*.hdf5"
        )
...
if __name__ == "__main__":
    builder = aloha_stack_bowls_three()
